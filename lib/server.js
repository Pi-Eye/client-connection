...
class ServerSide {
    constructor(port, cert_path, key_path, auth_function) {
        this.sockets_ = [];
        this.next_id_ = 0;
        ...
        this.https_ = https_1.default.createServer({
            cert: fs_1.default.readFileSync(this.cert_path_),
            key: fs_1.default.readFileSync(this.key_path_)
        });
        this.CreateServer();
